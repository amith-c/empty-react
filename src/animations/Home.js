...
class HomeAnim {
    ...
    intro() {
        this.transition.enterTransition('home', () => {
            gsap.timeline()
            ...
            ScrollTrigger.create({
                trigger: '.pitch .row-2',
                animation: gsap.timeline().to('.pitch .head-1 span', { translateY: 0, opacity: 1 }).to('.pitch .head-1 span', { backgroundSize: '100% 40%' }, 0.3).to('.pitch .body-grey', { translateY: 0, opacity: 1 }, 0.3),
                start: 'top 80%'
            })
